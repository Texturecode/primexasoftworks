        ...
        <div className="grid md:grid-cols-12 items-center gap-6">
          ...
          <div className="md:col-span-3 flex justify-center md:justify-start">
            <a href="#" className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-brand-500 to-brand-700 text-sm font-black text-white shadow-md shadow-brand-500/25">P</div>
              <div className="leading-none text-left">
                <div className="text-lg font-black tracking-[-0.08em] text-slate-800">PRIMEXA</div>
